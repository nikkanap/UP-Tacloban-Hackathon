...
import AllElectionsPage from "./pages/admin/AllElectionsPage";
import { AdminElectionProvider } from "./context/AdminElectionContext";
      ...
      candidates: [
        {
          ...
          name: "Candidate 10",
          party: "Party A",
          image: randomPerson10,
        },
        {
          id: 11,
          name: "Candidate 11",
          party: "Party B",
          image: randomPerson11,
        },
        {
          id: 12,
          name: "Candidate 12",
    ...
    <userContext.Provider value={userProfile}>
      <Routes>
        ...
        >
          ...
          <Route path="/admin/elections" element={<AllElectionsPage />} />
        </Route>
      </Routes>
